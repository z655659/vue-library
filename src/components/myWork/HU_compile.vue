	...
	<div id="myWorkChildren2">
		<div class="Asa_content" v-for="(item,index) in list">
			...
			<div class="Asa_arl fl">
				<h4 class="arl_size" title="ARLから転記">ARLから転記</h4>
				<p class="ARL_msg"><span class="ARL_msg_title">ARL-ID:</span><span>{{arlc_Data[0].arl_id}}</span></p>
				<p class="ARL_msg"><span class="ARL_msg_title">詳細:</span><span>{{arlc_Data[0].detail}}</span></p>
				<p class="ARL_msg"><span class="ARL_msg_title">転記してきた要件:</span><span>{{arlc_Data[0].from_info}}</span></p>
				<p class="ARL_msg"><span class="ARL_msg_title">備考、不明点:</span><span>{{arlc_Data[0].memo}}</span></p>
				<p class="ARL_msg"><span class="ARL_msg_title">状態:</span><span>{{arlc_Data[0].status}}</span></p>
				<p class="ARL_msg"><span class="ARL_msg_title">トリガー:</span><span>{{arlc_Data[0].trigger}}</span></p>
				<p class="ARL_msg"><span class="ARL_msg_title">動作:</span><span>{{arlc_Data[0].action}}</span></p>
				<el-button type="text" size="small" class="arl_btn" @click="examine_arltable(index)">查看</el-button>
			</div>
			<!-- HU -->
			<div class="Asa_Hu fl">
			...
			<div class="Asa_option fl">
				...
				<p class="option_size">
					<span class="option_title">AMP:</span>
						<el-input placeholder="0" class="opt_ipt" v-model="item.amp"></el-input>
				</p>
				<p class="option_size">
					<span class="option_title">DSRC:</span>
						<el-input placeholder="0" class="opt_ipt" v-model="item.dsrc"></el-input>
				</p>
				<p class="option_size">
					<span class="option_title">PCM:</span>
						<el-input placeholder="0" class="opt_ipt" v-model="item.dcm"></el-input>
				</p>
				<p class="option_size">
					<span class="option_title">RSE:</span>
						<el-input placeholder="0" class="opt_ipt" v-model="item.rse"></el-input>
				</p>
				<p class="option_size">
					<span class="option_title opt_line">Touch Pad:</span>
						<el-input placeholder="0" class="opt_ipt" v-model="item.touch_pad"></el-input>
				</p>
				<p class="option_size">
					<span class="option_title opt_line" >Soparate Disp:</span>
						<el-input placeholder="0" class="opt_ipt" v-model="item.separate_disp"></el-input>
				</p>
			...
			<div class="Asa_relevance fl">
				...
				<el-input  type="textarea" :rows="8"  v-model="item.rel_requirement"></el-input>
			</div>
			<!-- 责任分担 -->
			...
			<div class="Asa_dele fl">
				...
				<el-button type="text" size="small" class="operation_btn" @click="translate(index)">翻译</el-button>
				<el-button type="text" size="small" class="operation_btn" @click="recognize(index)">承认</el-button>
				<el-button type="text" size="small" class="operation_btn" >指摘</el-button>
			</div>
		</div>
		<!-- 悬浮保存按钮 -->
		...
		<el-dialog title="日付" :visible.sync="tiem_flag" class="ed_hm"  :modal-append-to-body="false">
		  ...
		  <el-button class="save fr">保存</el-button>
		</el-dialog>
	</div>
</template>
