	...
	export default {
			...
			methods:{
				...
				submitForm(event) {
			      ...
			      axios.post("http://172.26.11.56:5000/AnalysisContent",{content:this.content}).then((res) => {
...
//			   		axios.get("http://172.26.11.56:5000/AnalysisDelete/"+this.content.definition_id).then((res) => {
//			   			//alert("del成功")
//		       			})
//		       			.catch(function(err){
//				  	});
