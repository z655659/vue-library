<template>
	<div id='USER'>
		...
		<div class="left">
			<ul>
				<!-- <li><a href="javascript:;" @click='group'>管理员管理</a></li>
				<li><a href="javascript:;" @click='member'>组员管理</a></li>
				<li><a href="javascript:;" @click='member'>成员列表</a></li> -->
		...
		<!-- <el-row>		
				<el-col :span="5" :push="5">
					<span>组名</span>
					<el-select v-model="Groupv" placeholder="请选择组" >
						  <el-option
				...
				<el-row>
					...
					<el-button type="submit" class="Amember" @click="Amember">提交</el-button>
					</el-col>
		</el-row> -->
				</div>
				<el-form :model="addGroupMemberForm" ref="addGroupMemberForm" label-width="100px" class="demo-dynamic">
				  <el-form-item prop="group_id" label="组名" >
				    ...
				    <!-- <el-input v-model="addGroupMemberForm.group"></el-input> -->
				  </el-form-item>
				<!-- 添加组长 -->
			...
			<div id="list" class="flag list" v-if='L_flag'>
				...
				<div class="showlist">
					...
					<el-table :data="members" style="width:502px">
				      <el-table-column type="index" width="100">
				      </el-table-column>
	...
	export default {
		...
		methods:{
	     	VIP(){
	      	...
	      	getVgroups(){
	      		axios.get("http://192.168.10.13:45000/GroupAllGroups")
	      		.then(res=>{
	      	...
	      	submitForm(formName) {
		        this.$refs[formName].validate((valid) => {
		          if (valid) {
		          	//axios.post("http://192.168.10.13:45000/GpMemberAdd",this.addGroupMemberForm)
		     ...
		     //
			getmembers(){
				axios.get("http://192.168.10.13:45000/AllUsers")
				.then(res=>{
			...
			appendG(){
				axios.get("http://192.168.10.13:45000/GroupAdd/"+this.Group_name+this.Group_leader)
				alert("添加成功");
				axios.get("http://192.168.10.13:45000/GroupAllGroups")
	      		.then(res=>{
			...
			Amember(){
				...
				const leaders = this.Group_leaders;
				axios.post("http://192.168.10.13:45000/GpMemberAdd/",{group_id,members,leaders})
		    ...
		    handleDelete(index, row) {
		        ...
		        axios.get("http://192.168.10.13:45000/GroupDelete/"+id);
		    ...
		    //     return (member) => {
		    //       return (member.value.indexOf(queryString.toLowerCase()) === 0);
		    //     };
		    // },
		    // handleSelect(item) {
		    //     console.log(item);
